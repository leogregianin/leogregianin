...
- :seedling: :pray: Contribute with Open Source Software:
     ...
     * [python package cidade_ibge_tom](https://github.com/leogregianin/cidade_ibge_tom) Informações da Cidade pelo IBGE ou TOM.
     * [python package stock-exchange-holidays](https://github.com/leogregianin/stock-exchange-holidays) Worldwide Stock Exchange holidays (NYSE, CME, B3).
     * [python package siscomex-ncm](https://github.com/leogregianin/siscomex-ncm)
     * [python package gmail-wrapper](https://github.com/loadsmart/gmail-wrapper)
     * [python package workcalendar](https://github.com/workalendar/workalendar) Worldwide holidays and workdays computational toolkit.
     * [python package validate-docbr](https://github.com/alvarofpp/validate-docbr) validação de documentos brasileiros.
     * [python package viacep-python](https://github.com/leogregianin/viacep-python) informações do CEP com o webservice do site viacep.
     * [python package ibge](https://github.com/leogregianin/ibge) Data collection of geographical divisions of Brazil by IBGE.
     * [python package gtin-validator](https://github.com/charithe/gtin-validator) validates GTIN codes.
     * [python package heimdall](https://github.com/luizalabs/heimdall)
     * [python package xmltodict](https://github.com/martinblech/xmltodict)
     * [python package pynubank](https://github.com/andreroggeri/pynubank)
     * [python package juno-python](https://github.com/mjr/juno-python)
     * [django-requestlogs](https://github.com/Raekkeri/django-requestlogs)
     * [django-cities](https://github.com/coderholic/django-cities)
     * [django dr_scaffold](https://github.com/Abdenasser/dr_scaffold) scaffold django rest apis like a champion.
     * [golang package brdoc](https://github.com/paemuri/brdoc) 
     ...
     * [awesome-django-rest-framework](https://github.com/nioperas06/awesome-django-rest-framework) tools, processes and resources you need to create an awesome API with Django REST Framework. ![Stars](https://img.shields.io/github/stars/nioperas06/awesome-django-rest-framework?style=flat-square)
